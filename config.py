...
BOT_TOKEN = '5841971497:AAGh4QFbyhTIYFKFRBaKUDYrmG1acI7Ft6I' #Aqui va el token del bot
...
static_proxy = 'http://KFGGJJYGJKLHFKYEDIGDYJJEKEFKREEGLFDKLH' #agrega si kieres tener un proxy statico Con @raydel0307 si kieres comprar un proxy
